        ...
        if (prev_clans_cnt > cur_clans_cnt):
            ...
            for guild in client.guilds:
                ...
                overwrites = {
                    ...
                    role: discord.PermissionOverwrite(read_messages=False) # or whatever permissions the role should have
                }
                
                channel = await guild.create_text_channel(name=created_clan_name[0][0], overwrites=overwrites, category=category)
